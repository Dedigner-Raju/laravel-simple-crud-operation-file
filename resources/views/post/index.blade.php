            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                ...
                <div class="form-group">
                          <div class="btn btn-small btn-success"><a style="color:white;" href="{{ route('post.create') }}">  Add New Post </a></div>
                          <div class="btn btn-small btn-success"><a style="color:white;" href="{{ route('catagory.create') }}">Add Gategory </a></div>
                  </div>
