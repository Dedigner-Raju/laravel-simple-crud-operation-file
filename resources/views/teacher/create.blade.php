            ...
            <div class=" shadow">
                ...
                <div class="card-body">
                         <div class="form-group">
                           <div class="btn btn-small btn-success"><a style="color:white;" href="{{ route('teacher.index') }}">  All Teachers </a></div>
                         </div>
                        ...
                        <form action="{{ route('teacher.store') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input name="t_name" class="form-control" type="text">
                          </div>
                          ...
                          <div class="form-group">
                            <input name="submit" class="btn btn-success" type="submit" value="Add Teacher">
                          </div>
